...
func TestDefaultConfig(t *testing.T) {
	...
	if config.ErrorStrategy != errors.FailFast {
		t.Errorf("Expected ErrorStrategy to be errors.FailFast, got %v", config.ErrorStrategy)
	}
...
func TestConfigInherit(t *testing.T) {
	...
	if result.ErrorStrategy != errors.CollectAll {
		t.Errorf("Expected ErrorStrategy to be errors.CollectAll, got %v", result.ErrorStrategy)
	}
...
func TestConfigHierarchicalInheritance(t *testing.T) {
	...
	if parentResult.ErrorStrategy != errors.CollectAll {
	...
	if childResult.ErrorStrategy != errors.CollectAll {
...
func TestConfigCompositionOverInheritance(t *testing.T) {
	...
	if errorTolerantConfig.ErrorStrategy != errors.CollectAll {
		t.Error("Error tolerant config should have ErrorStrategy=errors.CollectAll")
	}
