...
func BenchmarkTask_GenericTypes(b *testing.B) {
	benchmarks := []struct {
		...
		{"String", func(ctx Context) (interface{}, error) { return "test", nil }},
		{"Int", func(ctx Context) (interface{}, error) { return 42, nil }},
		{"Slice", func(ctx Context) (interface{}, error) { return []int{1, 2, 3}, nil }},
		{"Map", func(ctx Context) (interface{}, error) { return map[string]int{"key": 1}, nil }},
		{"Struct", func(ctx Context) (interface{}, error) { return struct{ Name string }{"test"}, nil }},
	}
